...
import 'package:custom_place_picker/src/models/pick_result.dart';
...
class PlaceProvider extends ChangeNotifier {
  ...
  //* add nearby place list setter and getter
  List<PickResult> _nearbyPlaces;
  List<PickResult> get nearbyPlaces => _nearbyPlaces;
  set nearbyPlaces(List<PickResult> result) {
    _nearbyPlaces = result;
    notifyListeners();
  }
